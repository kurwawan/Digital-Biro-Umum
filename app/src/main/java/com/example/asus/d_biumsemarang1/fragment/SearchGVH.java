...
public class SearchGVH extends Fragment implements ViewHolderListener, View.OnClickListener {

    public static final String TAG = SearchGVH.class.getSimpleName();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            if (getArguments().getInt(SearchActivity.RIWAYAT_POSITION, 0) == 0) {
                mTitle = getString(R.string.gedung);
                mDatabaseQuery = "riwayat_gedung";
            } else {
                mTitle = getString(R.string.venue);
                mDatabaseQuery = "riwayat_venue";
            }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View content = inflater.inflate(R.layout.fragment_searchgvh, container, false);
    ...
    private void attachListener() {
        ...
        mReference.orderByChild("email_inf").startAt(mEmail + "_" + mQuery)
                .endAt(mEmail + "_" + mQuery + "\uf8ff").limitToFirst(50).addListenerForSingleValueEvent(mValueListener);
    ...
    private void showInfoResult(boolean value, boolean connection) {
        if (value) {
            ...
            if (connection) {
                ...
                mKeterangan1.setText(mContext.getString(R.string.search_historyNotFound, mTitle));
    ...
    private void showNoQuery() {
        mConnectionLinear1.setVisibility(View.VISIBLE);
        mKeterangan1.setText(mContext.getString(R.string.search_historyMessage, mTitle));
        mImage1.setImageResource(R.drawable.search_v2);
        mBtnCoba1.setVisibility(View.GONE);
    }

    private void checkMatchLastIndex(){

...
public class VenueFragment extends Fragment implements ViewHolderListener, View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
                    ...
                    if (clickPosition <= mData.size() - 1) {
                        ...
                        if (mData.get(clickPosition).getKey().equals(mLastClickKey)) {
                            if (newData != null) {
                                ...
                                Log.v(TAG, String.valueOf(needNotify));
                            }
                        }
                    }
                }
        ...
        mReference = mDatabase.getReference().child("venue");
    ...
    private void showInfoResult(boolean value, boolean connection) {
        if (value) {
            ...
            if (connection) {
                ...
                String venue = mContext.getString(R.string.venue);
                mKeterangan1.setText(mContext.getString(R.string.no_result, venue));
    ...
    private void proceedToFinal() {
        if (!isDestroyed) {
            ...
            mPreference.edit().putString(GedungVenueAdapter.NOTIFIY_ADAPTER, MainActivity.KODE_VENUE).apply();
        }
    }
}
